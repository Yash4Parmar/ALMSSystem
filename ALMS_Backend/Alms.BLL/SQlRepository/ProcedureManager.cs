...
namespace Service.Data.DBHelper
{
    ...
    public class ProcedureManager : IProcedureManager
    {
        ...
        private readonly WbLearningContext dbContext;
        private readonly IConfiguration configuration;
        //private ILogger logger = Log.ForContext(typeof(ProcedureManager));

        public ProcedureManager(WbLearningContext _dbContext, IConfiguration _configuration)
        {
