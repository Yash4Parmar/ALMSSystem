...
import { DataGrid, GridPaginationModel, GridSortDirection, GridSortItem, GridSortModel } from "@mui/x-data-grid";
...
const Table = ({ children, ...props }: PropsWithChildren<DynamicTable.TableProps>) => {
